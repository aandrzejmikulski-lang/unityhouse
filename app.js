...
// Formularz zgłoszenia (na razie tylko UI)
...
btnSaveTicket.addEventListener("click", async () => {
  ...
  // Tu później dodamy zapis do Supabase (tabela tickets + storage na załączniki)
  showMessage(ticketFormMessage, "Zgłoszenie zostanie zapisane (logika w kolejnym kroku).", "success");
});

// Ładowanie zgłoszeń (placeholder)
async function loadTickets() {
  ticketsList.innerHTML = "";

  // Na razie przykładowe dane – później zastąpimy zapytaniem do Supabase
  const demoTickets = [
    {
      id: 1,
